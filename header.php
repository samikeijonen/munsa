...
<div id="preloader" class="preloader">
    <div id="status" class="status"><span class="screen-reader-text"><?php esc_html_e( 'Site is loading', 'munsa' ); ?></span></div>
</div>
...
<div id="site-wrapper" class="site-wrapper">
	<div id="page" class="site">
		...
		<?php get_template_part( 'template-parts/content', 'header' ); // Loads the template-parts/content-header.php template. ?>
