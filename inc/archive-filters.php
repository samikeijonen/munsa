 ...
 * @return string
 */
function munsa_archive_title_filter( $title ) {
	...
	return apply_filters( 'munsa_archive_title', $title );
}
add_filter( 'get_the_archive_title', 'munsa_archive_title_filter', 5 );
 ...
 * @return string
 */
function munsa_archive_description_filter( $desc ) {
	...
	return apply_filters( 'munsa_archive_description', $desc );
}
add_filter( 'get_the_archive_description', 'munsa_archive_description_filter', 5 );